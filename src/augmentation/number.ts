Number.prototype.memory = function (unit?: "B" | "KB" | "MB" | "GB"): string {
    ...
    switch (unit) {
        ...
        case "KB": return (bytes / 1_000).toFixed(1).concat("KB");
        case "MB": return (bytes / 1_000_000).toFixed(1).concat("MB");
        case "GB": return (bytes / 1_000_000_000).toFixed(1).concat("GB");
    }
}
...
Number.prototype.time = function (type: "ss" | "mm" | "hh" | "mm:ss" | "hh:mm" | "hh:mm:ss"): string {
